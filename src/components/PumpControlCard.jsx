    ...
    return (
        ...
        <div className="p-6 bg-white rounded-3xl shadow-lg flex flex-col justify-between font-sans w-full mx-auto border border-slate-200 max-w-[800px]">
            ...
            <div className="flex justify-between w-full items-center">
                ...
                {user.role === 'USER' && <div class="flex items-center mt-2 p-2 text-xs text-red-800 border border-red-300 rounded-lg bg-red-50 dark:bg-gray-800 dark:text-red-400 dark:border-red-800" role="alert">
                    <svg class="shrink-0 inline w-4 h-4 me-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
                        <path d="M10 .5a9.5 9.5 0 1 0 9.5 9.5A9.51 9.51 0 0 0 10 .5ZM9.5 4a1.5 1.5 0 1 1 0 3 1.5 1.5 0 0 1 0-3ZM12 15H8a1 1 0 0 1 0-2h1v-3H8a1 1 0 0 1 0-2h2a1 1 0 0 1 1 1v4h1a1 1 0 0 1 0 2Z" />
                    </svg>
                    <span class="sr-only">Info</span>
                    <div>
                        <span class="font-small">You Do not have Permission to Operate Pump.</span>
                    </div>
                </div>}
                <div className="flex items-center gap-3">
